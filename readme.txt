...
* **Bug Fixes**
	...
	* Fixed an issue where enabling the Image Check could cause single and double quotes to become question marks.
...
* **Updates**
	...
	* Compatability check with the latest version of Yoast SEO and WordPress.
...
* **Bug Fixes**
	...
	* Corrected an issue where if using the Image feature for title & alt tags that it would throw an error if either title or alt contained certain characters like: &, ', ", etc. All values are now properly escaped. This should help with some non-English languages as well but further fixes may be required in those cases.
...
Fixes issues with quotes becoming question marks.
